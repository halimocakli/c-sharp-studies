...
namespace NetFramework.S19.D1.DelegateNedir
{
    ...
    * Metot imzası, bir metodun aldığı parametreler, bu parametrelerin veri türü ve geri döndürdüğü değerin veri türüdür.
    ...
    * Kısacası delegate'ler bir metot silsilesidir, metotları işaret eder ve çalıştığında bir veya birden fazla metodu tetikler.
    * Metotlar, delegate'nin içine eklenen sıra ile çalışır.
    *
    ...
    */
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // MatematikselIslemler delegemizi örnekledik, yarattığımız nesnenin Topla metodunu işaret etmesini sağladık.
