...
namespace NetFramework.S07.D1.MetotGenelTanim
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * "SınıfAdi.Metot();" şeklinde bir prototipe sahip olmalıdır.
             */
            ...
            * Public erişim belirleyici tipinde hiç bir kısıtlama yoktur.

            * PRIVATE
            * -------
            * Bir değerin private olarak tanımlanması demek, o değişkene sadece kendi class’ı içinden ulaşılabileceği anlamına gelmektedir. Program içinde kesinlikle 
            * değiştirilmemesi gereken, kritik kodlarda kullanılmaktadır. Ayrıca; private, varsayılan erişim belirleyici tipidir. Örneğin; “int deneme = 0;” gibi bir 
            * değişken tanımlandığında program tarafından deneme değeri privateolarak algılanmaktadır.
            *
            * PROTECTED
            * ---------
            * Kod içinde bir değerin protected olarak tanımlanması; o değere, bulunduğu class  ve ondan türetilen diğer sınıflar içinden erişilebilir olduğunu 
            * göstermektedir. Protected; bir anlamda, public ve private erişim belirleyicilerinin birleşimi olarak görülebilmektedir.
            *
            * INTERNAL
            * --------
