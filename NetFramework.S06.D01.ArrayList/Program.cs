...
namespace NetFramework.S06.D1.ArrayListGenelKullanim
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             *
             * Klasik diziler ile çalışırken çoğu zaman diziyi hangi boyutta yaratacağımız belli olmaz. Bu tür durumlarda dizi yeteri kadar büyüklükte yaratılır. Yartılan dizinin
